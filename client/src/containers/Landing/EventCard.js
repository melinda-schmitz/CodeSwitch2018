		...
		return (
			<Card className={classes.card}>
				...
				<CardActions>
					...
					<Button className="app-btn save-event-btn" variant="contained" color="primary" size="small"><span className={classes.btnText}>Save Event</span><i className="fas fa-check fa-2x"></i></Button>
				</CardActions>
			</Card >
		)
	}
